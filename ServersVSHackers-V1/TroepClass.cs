...
namespace ServersVSHackers_V1
{
    ...
    public class TroepClass
    {
         ...
         ConcurrentBag<IEntity> cbEntities = new ConcurrentBag<IEntity>();
            ...
            Parallel.For((long) 0, _numberOfServers, i => cbEntities.Add(new Server()));


            Parallel.For((long) 0, _numberOfHackers, i => cbEntities.Add(new Hacker()));
